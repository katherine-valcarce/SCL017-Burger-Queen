  ...
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalToggleLabel">¿Confirmas el pedido?</h5>
      </div>
      ...
      <button type="button" className="btn btn-dark" data-bs-dismiss="modal">NO</button>
        <button className="btn btn-light" data-bs-target="#exampleModalToggle2"  onClick={()=>savingDataFirebase(cartItems,mesero,mesa)}  data-bs-toggle="modal" data-bs-dismiss="modal">SI</button>
...
<div className="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabIndex="-1">
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      <div className="modal-header">
        <button type="button" className="btn-close" data-bs-dismiss="modal" onClick={() => resetOrder()} aria-label="Close"></button>
      </div>
      <div className="modal-body">
